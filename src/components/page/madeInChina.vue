<template>
    <div class="merchant-container">
        ...
        <el-table v-loading="listLoading" :data="list" @selection-change="setSelectRows">
            ...
            <el-table-column width="300px" label="公司名称">
            ...
            <el-table-column align="center" label="操作" width="100">
                <template #default="{ row }">
                    <el-button link type="danger" v-if="row.sign_time" @click="handleDelete(row, '取消')">取消</el-button>
                    <el-button link type="info" v-else @click="handleDelete(row, '')">标记</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
